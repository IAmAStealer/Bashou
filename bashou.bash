...
_bashou_commands="level pets achievements fight talk learn explain evolve swap stats start language config setup update version security adventure reset dev on off"
