...
ALL = [
    Challenge(level=2, id="mirror_mimic", fix=True, pet="ant", tools=EDITORS, distro=DEBIAN, skill="debian", requires=["sed"],
              threat="Mirror Mimic",
    ...
    Challenge(level=2, id="repo_revenant", fix=True, pet="ant", tools=EDITORS, distro=REDHAT, skill="rocky", requires=["sed"],
    ...
    Challenge(level=2, id="enabled_ettin", fix=True, pet="ant", tools=("dnf", "yum"), distro=REDHAT, skill="rocky", requires=["dnf"],
