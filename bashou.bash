...
_bashou_commands="level pets achievements fight talk learn explain lesson share evolve swap stats start language skills config setup update version security adventure reset dev on off"
