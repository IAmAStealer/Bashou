...
Pages. The card's data (pet, level, a few counts, the skills you ticked and your nickname) sits after the `#`, which browsers keep to themselves: it never reaches GitHub or any
